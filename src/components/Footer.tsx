          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex gap-3">
                ...
                <a href="tel:+27100167454" className="hover:text-white transition-colors">+27 10 016 7454</a>
              </li>
              <li className="flex gap-3">
                <Mail size={18} className="shrink-0 text-stone-500" />
                <a href="mailto:alainkale@yahoo.com" className="hover:text-white transition-colors">alainkale@yahoo.com</a>
              </li>
            </ul>
          </div>
        </div>
