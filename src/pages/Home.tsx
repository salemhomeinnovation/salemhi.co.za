    ...
    <main>
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-6 max-w-4xl">
          ...
          >
            <Link to="/contact" className="bg-white text-stone-900 px-10 py-5 rounded-sm text-xs uppercase tracking-widest font-semibold hover:bg-stone-100 transition-colors">
              Request Consultation
            </Link>

            <Link to="/services" className="border border-white/50 text-white px-10 py-5 rounded-sm text-xs uppercase tracking-widest font-semibold hover:bg-white/10 transition-colors backdrop-blur-sm">
              Our Services
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-32 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl font-serif leading-tight">Property Improvement & Management Experts</h2>
      ...
      <section className="py-32 px-6 bg-stone-900 text-white text-center">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/services" className="border border-white/30 text-white px-10 py-5 rounded-sm text-xs uppercase tracking-widest font-semibold hover:bg-white/10 transition-colors">
              View Services
            </Link>
